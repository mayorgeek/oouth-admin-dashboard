        ...
        <aside id="layout-menu" className="layout-menu menu-vertical menu bg-menu-theme">
            <div className="app-brand demo">
                <a href="index.html" className="app-brand-link">
                    <span className="app-brand-text demo menu-text fw-bolder ms-2">Admin Dashboard</span>
                </a>
            ...
            <ul className="menu-inner py-1">
                ...
                <li className="menu-item">
                    <NavLink to="/drugs" className="menu-link" end>
                        <i className="menu-icon tf-icons bx bx-message-dots"></i>
                        <div data-i18n="Analytics">Drugs</div>
                    </NavLink>
                </li>
                <li className="menu-item">
                    <NavLink to="/add-drug" className="menu-link" end>
                        <i className="menu-icon tf-icons bx bx-message-dots"></i>
                        <div data-i18n="Analytics">Add Drug</div>
                    </NavLink>
                </li>
                <li className="menu-item">
